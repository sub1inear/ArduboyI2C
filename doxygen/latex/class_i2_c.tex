...
static void \mbox{\hyperlink{class_i2_c_afb38ec006200442dbdca3fecc9af0d03}{write}} (uint8\+\_\+t address, const void \texorpdfstring{$\ast$}{*}buffer, uint8\+\_\+t size, bool wait)
...
{\footnotesize template$<$typename T $>$ }\\static void \mbox{\hyperlink{class_i2_c_ac23f4a0728d98898318dbf56e9b5232d}{write}} (uint8\+\_\+t address, const T \texorpdfstring{$\ast$}{*}object, bool wait)
\begin{DoxyCompactList}\small\item\em Attempts to become the bus controller (master) and sends data over \doxylink{class_i2_c}{I2C} to the specified address. \end{DoxyCompactList}\item 
static void \mbox{\hyperlink{class_i2_c_a7fa12af5a3f24c3db496672a4d5c3fe0}{read}} (uint8\+\_\+t address, void \texorpdfstring{$\ast$}{*}buffer, uint8\+\_\+t size)
...
{\footnotesize template$<$typename T $>$ }\\static void \mbox{\hyperlink{class_i2_c_ae2599143656ddbbaa877e4809ff2f1cf}{read}} (uint8\+\_\+t address, T \texorpdfstring{$\ast$}{*}object)
\begin{DoxyCompactList}\small\item\em Attempts to become the bus controller (master) and reads data over \doxylink{class_i2_c}{I2C} from the specified address. \end{DoxyCompactList}\item 
static void \mbox{\hyperlink{class_i2_c_a6d2695878ede6f9ded985230afeaad99}{transmit}} (const void \texorpdfstring{$\ast$}{*}buffer, uint8\+\_\+t size)
\begin{DoxyCompactList}\small\item\em Transmits data back to the controller (master). \end{DoxyCompactList}\item 
{\footnotesize template$<$typename T $>$ }\\static void \mbox{\hyperlink{class_i2_c_a5c340ab5b950b9f35fdd6f9c3498e08b}{transmit}} (const T \texorpdfstring{$\ast$}{*}object)
\begin{DoxyCompactList}\small\item\em Transmits data back to the controller (master). \end{DoxyCompactList}\item 
static void \mbox{\hyperlink{class_i2_c_a026eaad0ba8bb6a698d3eaca9dd9887d}{on\+Request}} (void(\texorpdfstring{$\ast$}{*}function)())
\begin{DoxyCompactList}\small\item\em Sets up the callback to be called when data is requested from the device\textquotesingle{}s address (a read). \end{DoxyCompactList}\item 
static void \mbox{\hyperlink{class_i2_c_aba82f80b86f08e2caf0f6cab4860728d}{on\+Receive}} (void(\texorpdfstring{$\ast$}{*}function)())
\begin{DoxyCompactList}\small\item\em Sets up the callback to be called when data is sent to the device\textquotesingle{}s address (a write) \end{DoxyCompactList}\item 
...
{\em id} & An id between 0 and I2\+C\+\_\+\+MAX\+\_\+\+ADDRESSES -\/ 1 \\
\hline
\end{DoxyParams}
...
Sets up the callback to be called when data is sent to the device\textquotesingle{}s address (a write) 
...
\doxylink{class_i2_c_a026eaad0ba8bb6a698d3eaca9dd9887d}{on\+Request()} \doxylink{class_i2_c_afb38ec006200442dbdca3fecc9af0d03}{write()} 
\end{DoxySeeAlso}
...
Sets up the callback to be called when data is requested from the device\textquotesingle{}s address (a read). 
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{class_i2_c_a6d2695878ede6f9ded985230afeaad99}{I2C::transmit}}(\&players[\textcolor{keywordtype}{id}],\ 2);}
\DoxyCodeLine{\}}
\DoxyCodeLine{...}
\DoxyCodeLine{void\ setup()\ \{}
\DoxyCodeLine{\ \ ...}
...
\end{DoxyCode}
 \begin{DoxyNote}{Note}
To respond to the controller (master), use {\ttfamily transmit} instead of {\ttfamily write}. 

If no bytes are send in the callback, the result of the transmission is undefined. 
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\doxylink{class_i2_c_aba82f80b86f08e2caf0f6cab4860728d}{on\+Receive()} \doxylink{class_i2_c_a6d2695878ede6f9ded985230afeaad99}{transmit()} \doxylink{class_i2_c_a7fa12af5a3f24c3db496672a4d5c3fe0}{read()} 
\end{DoxySeeAlso}
\Hypertarget{class_i2_c_ae2599143656ddbbaa877e4809ff2f1cf}\index{I2C@{I2C}!read@{read}}
\index{read@{read}!I2C@{I2C}}
\doxysubsubsection{\texorpdfstring{read()}{read()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \label{class_i2_c_ae2599143656ddbbaa877e4809ff2f1cf} 
template$<$typename T $>$ \\
static void I2\+C\+::read (\begin{DoxyParamCaption}\item[{uint8\+\_\+t}]{address}{, }\item[{T \texorpdfstring{$\ast$}{*}}]{object}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
{\em T} & The type of the data to read. \\
\hline
\end{DoxyTemplParams}
...
\hline
\end{DoxyParams}
Types with sizes larger than 255 should not be used with this function. \begin{DoxyNote}{Note}
Unlike the {\ttfamily write} function, this function is bufferless and is not limited to 32 bytes. 
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\doxylink{class_i2_c_afb38ec006200442dbdca3fecc9af0d03}{write()} 
\end{DoxySeeAlso}
\Hypertarget{class_i2_c_a7fa12af5a3f24c3db496672a4d5c3fe0}\index{I2C@{I2C}!read@{read}}
\index{read@{read}!I2C@{I2C}}
\doxysubsubsection{\texorpdfstring{read()}{read()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{class_i2_c_a7fa12af5a3f24c3db496672a4d5c3fe0} 
static void I2\+C\+::read (\begin{DoxyParamCaption}\item[{uint8\+\_\+t}]{address}{, }\item[{void \texorpdfstring{$\ast$}{*}}]{buffer}{, }\item[{uint8\+\_\+t}]{size}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
\end{DoxyNote}
\Hypertarget{class_i2_c_a5c340ab5b950b9f35fdd6f9c3498e08b}\index{I2C@{I2C}!transmit@{transmit}}
\index{transmit@{transmit}!I2C@{I2C}}
\doxysubsubsection{\texorpdfstring{transmit()}{transmit()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \label{class_i2_c_a5c340ab5b950b9f35fdd6f9c3498e08b} 
template$<$typename T $>$ \\
static void I2\+C\+::transmit (\begin{DoxyParamCaption}\item[{const T \texorpdfstring{$\ast$}{*}}]{object}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
\begin{DoxyTemplParams}{Template Parameters}
{\em T} & The type of data to transmit. \\
\hline
\end{DoxyTemplParams}

\begin{DoxyParams}{Parameters}
{\em object} & A pointer to the data to send.\\
\hline
\end{DoxyParams}
...
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\doxylink{class_i2_c_afb38ec006200442dbdca3fecc9af0d03}{write()} \doxylink{class_i2_c_a026eaad0ba8bb6a698d3eaca9dd9887d}{on\+Request()} 
\end{DoxySeeAlso}
\Hypertarget{class_i2_c_a6d2695878ede6f9ded985230afeaad99}\index{I2C@{I2C}!transmit@{transmit}}
\index{transmit@{transmit}!I2C@{I2C}}
\doxysubsubsection{\texorpdfstring{transmit()}{transmit()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{class_i2_c_a6d2695878ede6f9ded985230afeaad99} 
static void I2\+C\+::transmit (\begin{DoxyParamCaption}\item[{const void \texorpdfstring{$\ast$}{*}}]{buffer}{, }\item[{uint8\+\_\+t}]{size}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
\doxylink{class_i2_c_afb38ec006200442dbdca3fecc9af0d03}{write()} \doxylink{class_i2_c_a026eaad0ba8bb6a698d3eaca9dd9887d}{on\+Request()} 
\end{DoxySeeAlso}
\Hypertarget{class_i2_c_ac23f4a0728d98898318dbf56e9b5232d}\index{I2C@{I2C}!write@{write}}
\index{write@{write}!I2C@{I2C}}
\doxysubsubsection{\texorpdfstring{write()}{write()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \label{class_i2_c_ac23f4a0728d98898318dbf56e9b5232d} 
template$<$typename T $>$ \\
static void I2\+C\+::write (\begin{DoxyParamCaption}\item[{uint8\+\_\+t}]{address}{, }\item[{const T \texorpdfstring{$\ast$}{*}}]{object}{, }\item[{bool}]{wait}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
\begin{DoxyTemplParams}{Template Parameters}
{\em T} & The type of the data to write. \\
\hline
\end{DoxyTemplParams}
...
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\doxylink{class_i2_c_a6d2695878ede6f9ded985230afeaad99}{transmit()} \doxylink{class_i2_c_a7fa12af5a3f24c3db496672a4d5c3fe0}{read()} 
\end{DoxySeeAlso}
\Hypertarget{class_i2_c_afb38ec006200442dbdca3fecc9af0d03}\index{I2C@{I2C}!write@{write}}
\index{write@{write}!I2C@{I2C}}
\doxysubsubsection{\texorpdfstring{write()}{write()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{class_i2_c_afb38ec006200442dbdca3fecc9af0d03} 
static void I2\+C\+::write (\begin{DoxyParamCaption}\item[{uint8\+\_\+t}]{address}{, }\item[{const void \texorpdfstring{$\ast$}{*}}]{buffer}{, }\item[{uint8\+\_\+t}]{size}{, }\item[{bool}]{wait}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
